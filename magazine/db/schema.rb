...
ActiveRecord::Schema.define(version: 20170103134250) do
  ...
  create_table "articles_images", force: :cascade do |t|
    t.integer  "article_id"
    t.integer  "image_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  add_index "articles_images", ["image_id"], name: "index_articles_images_on_image_id"
